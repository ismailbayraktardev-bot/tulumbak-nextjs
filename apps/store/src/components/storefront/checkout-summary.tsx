    ...
    <Card className="sticky top-8">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex justify-between text-lg font-semibold">
          <span>Toplam</span>
          <span className="text-tulumbak-amber">{formatPrice(total)}</span>
        </div>
        ...
        {/* Delivery Info */}
        <div className="bg-tulumbak-beige p-3 rounded-lg">
          <h4 className="text-sm font-medium text-tulumbak-slate mb-1">
            Teslimat Bilgileri
          </h4>
          <p className="text-xs text-gray-600">
            İstanbul içi 2-4 saat, diğer şehirlere 1-2 gün içinde teslimat yapılır.
          </p>
        </div>

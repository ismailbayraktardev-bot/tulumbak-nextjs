      ...
      <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <div className="relative flex flex-1">
          ...
          <input
            type="search"
            placeholder="Ara..."
            className="block h-full w-full border-0 py-0 pl-10 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-tulumbak-amber sm:text-sm"
          />
        </div>
      </div>
